...
class ChannelScreenHash extends React.Component {
  constructor(props){
    super(props);
  }
    ...
    return (
      ...
      <View style={{flex : 1, justifyContent : 'center', alignItems : 'center'}}>
        <View style={{justifyContent : 'center', alignItems : 'center', backgroundColor : '#555', padding : 15, borderRadius : 10}}>
          <Text style={{fontSize : 16, color : '#fff', margin : 3}}>You are trying to access a private channel.</Text>
          <Text style={{fontSize : 12, color : '#fff', margin : 3}}>Please enter a digital hash.</Text>
...
export default ChannelScreenHash;
