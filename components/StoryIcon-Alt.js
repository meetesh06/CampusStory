        ...
        return(
            ...
            > */}
                            ...
                            <LinearGradient style={{ borderRadius: 10, opacity: 0.6, flex: 1, position: 'absolute', width: this.props.width, height: this.props.height }} colors={['#505050', '#000']}>
                                <Text numberOfLines = {1} lineBreakMode = 'tail' style={{textAlign : 'center', fontSize : 10, fontWeight : '500', color : '#fff', marginTop : this.props.height - 20, marginRight : 8, marginLeft : 8}}>{this.props.item.name}</Text>
                            </LinearGradient>
